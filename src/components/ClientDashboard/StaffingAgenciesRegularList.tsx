...
const StaffingAgenciesRegularList: React.FC<StaffingAgenciesRegularListProps> = ({ applywizzId }) => {
    ...
    const renderJobCard = (job: JobItem, date: string) => {
        ...
        const fallbackAvatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(job.company || 'Company')}&background=f97316&color=fff&size=80&bold=true&rounded=true`;
