...
import { Calendar, Briefcase, MapPin, ExternalLink, ChevronDown, ChevronUp, Loader2, DollarSign, Building, Monitor, Zap } from "lucide-react";
...
const IndeedEasyApplyRegularList: React.FC<IndeedEasyApplyRegularListProps> = ({ applywizzId }) => {
    ...
    const renderJobCard = (job: JobItem, date: string) => {
        ...
        const fallbackAvatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(job.company || 'Company')}&background=2164F3&color=fff&size=128&bold=true&rounded=true`;
