...
interface IndeedEasyApplyDashboardProps {
    applywizzId?: string;
}

const IndeedEasyApplyDashboard: React.FC<IndeedEasyApplyDashboardProps> = ({ applywizzId }) => {
    ...
    // Calculate totals
    const totalIndeed = chartData.reduce((sum, item) => sum + item.IndeedCount, 0);
                ...
                <div className="bg-white p-4 rounded-lg shadow-lg border border-gray-200">
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600">Indeed Jobs:</span>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                {/* Total Indeed Jobs Card */}
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-blue-100 text-sm font-medium">Total Indeed Easy Apply Jobs</p>
                            <p className="text-3xl font-bold mt-2">{totalIndeed}</p>
                        </div>
            ...
            <div className="bg-white p-6 shadow-lg rounded-xl border border-gray-100">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-bold text-gray-800">Indeed Easy Apply Jobs Over Time</h2>
                </div>
                ...
                {chartData.length > 0 ? (
                        ...
                        >
                            <defs>
                                <linearGradient id="colorIndeed" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="0%" stopColor="#2164F3" stopOpacity={0.9} />
                                    <stop offset="100%" stopColor="#1a4db8" stopOpacity={0.9} />
                                </linearGradient>
                            </defs>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-gray-400">
                        ...
                        <p className="text-lg font-medium">No Indeed jobs data available</p>
                    </div>
                )}
            </div>
        </div>
...
export default IndeedEasyApplyDashboard;
