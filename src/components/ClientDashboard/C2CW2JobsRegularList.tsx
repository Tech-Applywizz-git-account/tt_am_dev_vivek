...
import { Calendar, RefreshCw, MapPin, ExternalLink, ChevronDown, ChevronUp, Loader2, Briefcase, DollarSign, Building, Monitor } from "lucide-react";
...
const C2CW2JobsRegularList: React.FC<C2CW2JobsRegularListProps> = ({ applywizzId }) => {
    ...
    const renderJobCard = (job: JobItem, date: string) => {
        ...
        const fallbackAvatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(job.company || 'Company')}&background=14b8a6&color=fff&size=128&bold=true&rounded=true`;
